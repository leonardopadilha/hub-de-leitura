document.addEventListener('DOMContentLoaded', function() {
    ...
    function adaptHeaderForLibrary() {
        ...
        const links = document.querySelectorAll('a[href="/cart.html"], a[href="/dashboard.html"]');
        
        links.forEach(link => {
            if (link.textContent.includes('CARRINHO') || link.textContent.includes('MINHAS RESERVAS')) {
                link.href = '/cart.html';
                ...
                parentLi.innerHTML = `
                    ...
                    <a href="/dashboard.html" class="user-info d-flex align-items-center text-dark text-decoration-none me-2" 
                       title="Meu Dashboard">
                        ...
                        ${isAdmin ? '<i class="fas fa-crown text-warning ms-1" title="Administrador"></i>' : ''}
                    </a>
